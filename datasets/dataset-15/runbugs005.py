...
#datasetdirpath = r"C:\Users\Paul Bilokon\Documents\dev\alexandria\bilokon-msc\dissertation\code\datasets\dataset-15"
datasetdirpath = r"C:\Users\Paul\Documents\dev\alexandria\bilokon-msc\dissertation\code\datasets\dataset-15"
outdirpath = 'C:/temp/3'

for i in range(112, 122):
    filebasename = 'dataset-15-%d-%d' % (ticksperday, i)
