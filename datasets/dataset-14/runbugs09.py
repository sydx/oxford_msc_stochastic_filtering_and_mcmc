...
for i in range(80, 90):
    ...
    with open(scriptfilepath, 'w') as o:
        o.write("display('log')")
        o.write("check('C:/Users/Paul Bilokon/Documents/dev/alexandria/bilokon-msc/dissertation/code/mcmc/svl.txt')\n")
        o.write("data('%s')\n" % os.path.join(tempoutdirpath, '%s_n.txt' % filebasename).replace('\\', '/'))
        o.write("data('%s')\n" % os.path.join(tempoutdirpath, '%s_y.txt' % filebasename).replace('\\', '/'))
        o.write("compile(1)\n")
        o.write("inits(1, 'C:/Users/Paul Bilokon/Documents/dev/alexandria/bilokon-msc/dissertation/code/mcmc/svl-inits.txt')\n")
        o.write("gen.inits()\n")
